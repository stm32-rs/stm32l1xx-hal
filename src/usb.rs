...
//! See https://github.com/stm32-rs/stm32l1xx-hal/tree/master/examples
//! for usage examples.
...
unsafe impl UsbPeripheral for Peripheral {
    ...
    fn startup_delay() {
        // There is a chip specific startup delay. For STM32L15x it's 1µs and this should wait for
        // at least that long.
